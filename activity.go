...
type AutoGenerated struct {
	Data struct {
		...
		MsgSpoolUsage                  float64     `json:"msgSpoolUsage"`
...
func (a *unmarshaljson) Eval(ctx activity.Context) (done bool, err error) {
	...
	fmt.Println("%+v",json_data.Data.Counter.BindCount)
	fmt.Println(" JSON String ********************************** ")
	log.Println("%+v",json_data.Data.Counter.BindCount)
	...
	ctx.SetOutput("output", json_data.Data.Counter.BindCount)
